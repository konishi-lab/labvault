...
最終更新: 2026-06-23 (PR #82 反映 — N1-N3 緊急 hot fix 完了)

---

## 🚨 緊急 ✅ **済 (PR #82)**

3 観点クリティカルレビューで発覚した本番実害 3 件を 1 PR で潰した:
...
tests +2 (backend 133→135)。本番 deploy 後の確認項目:
- Cloud Logging で `firestore.client_reset` がゼロのまま (N3 効果)
- `/records?template=XRD` を直開きで UI ロックしない (N1 効果)
